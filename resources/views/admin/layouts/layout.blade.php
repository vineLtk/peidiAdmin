...
<head>
    ...
    <title>{{isset($current_menu)?data_get($current_menu, 'children.0.text', data_get($current_menu, 'text')):''}} | {{config('app.name')}}</title>
    <!-- Favicon-->
    ...
    <link rel="stylesheet" href="{{asset('atrio1.4/assets/css/styles/all-themes.css')}}">
</head>
...
<body class="light">
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/">
                    <img src="{{asset('atrio1.4/assets/images/logo.png')}}" alt="" />
    ...
    <div>
        ...
        <aside id="leftsidebar" class="sidebar">
            <!-- Menu -->
            @include('admin.layouts._menu_new')
            <!-- #Menu -->
        </aside>
        <!-- #END# Left Sidebar -->
    </div>
